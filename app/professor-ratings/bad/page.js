...
export default function BadProfessors() {
  ...
  const badProfessors = [...professors, ...pendingProfessors].filter(prof => 
    prof.rating < 4.0 &&
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>教授黑榜</h1>
